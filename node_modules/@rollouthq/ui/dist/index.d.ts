...
declare function ArrowRight(props: IconProps): JSX.Element;
...
declare function EmptyBlock(props: IconProps): JSX.Element;

declare function File$1(props: IconProps): JSX.Element;
...
declare type FileBrowserProps = {
    ...
    setValue: (newVal: string | undefined) => void;
    fetchOptions: (folderPath: string) => Promise<File[]>;
};
declare function FileBrowser(props: FileBrowserProps): JSX.Element;
